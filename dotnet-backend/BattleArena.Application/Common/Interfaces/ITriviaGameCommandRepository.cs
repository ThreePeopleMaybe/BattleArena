...
public interface ITriviaGameCommandRepository
{
    ...
    Task<long> InsertTriviaGameResultAsync(long gameId, long userId, int topicId, int numberOfCorrectAnswers, int timeTakenInSeconds, CancellationToken cancellationToken = default);
